...
* fixed invalid change log links to release tag

## [2.0.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/2.0.0) - released at 16.09.2019
...
## [1.2.2](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.2.2) - released at 08.11.2017

### Changed

* fixed error in the generated doc-block when fully qualified names are generated ("@return \Foo" instead of "@return Foo")

## [1.2.1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.2.1) - released at 07.11.2017

### Changed

* fixed errors in the [readme](README.md)

## [1.2.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.2.0) - released at 07.11.2017
...
## [1.1.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.1.0) - released at 03.08.2017
...
## [1.0.2](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.0.2) - released at 23.01.2017

### Changed

* updated depenency

## [1.0.1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.0.1) - released at 30.05.2016
...
## [1.0.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/1.0.0) - released at 06.03.2016
...
## [0.4.3](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.4.2) - released at 11.01.2016

### Changed

* fixed dependency handling for phpunit 4.8.*

## [0.4.2](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.4.2) - released at 11.12.2015

### Changed

* updated dependencies

## [0.4.1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.4.1) - released at 06.11.2015

### Changed

* updated dependencies

## [0.4.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.4.0) - released at 20.09.2015

### Changed

* refactor *EntityInstantiatorGenerator* (extracted *generateContent* and *configure* method to delegate responsibilities)

## [0.3.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.3.0) - released at 18.09.2015
...
## [0.2.3](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.2.3) - released at 17.09.2015
...
## [0.2.2](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.2.2) - released at 10.09.2015

### Changed

* refactored `EntityInstantiatorGenerator` internal code generation

## [0.2.1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.2.1) - released at 09.09.2015

### Added

* added "$name" and "$mode" as optional parameter for "getConnection()"

## [0.2.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.2.0) - released at 09.09.2015

### Changed

* fixed [issues/1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/issues/1)

## [0.1.2](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.1.2) - released at 02.09.2015

### Changed

* changed default method prefix from "databaseName" to "createDatabaseName"

## [0.1.1](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.1.1) - released at 31.08.2015

### Added

* added optional parameter `extends`

## [0.1.0](https://github.com/bazzline/php_propel_behavior_entity_instantiator/tree/0.1.0) - released at 31.08.2015
